              ...
              <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10 shadow-xl">
                <div className="flex flex-col gap-6 text-white">
                  ...
                  <div>
                    ...
                    <a 
                      className="font-['Pretendard:Regular',sans-serif] text-lg hover:text-gray-300 transition-colors underline decoration-gray-500 hover:decoration-white leading-relaxed break-all" 
                      href="https://www.behance.net/peu111189e7f/projects"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      behance.net/peu111189e7f
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-2xl p-10 border border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="font-['Pretendard:Regular',sans-serif] text-gray-300">
                      <p className="mb-4">
                        <span className="font-['Pretendard:SemiBold',sans-serif] text-xl text-white">Budget Buddy</span>
                        <br />
                        <span className="text-sm text-gray-500">(2024.05 ~ 06)</span>
                      </p>
                      <p className="text-base leading-[1.8]">
                        Samsung Pay 기반 e-Wallet 소비습관에 새로운 가치를 제공하는 제품
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="font-['Pretendard:Regular',sans-serif] text-gray-300">
                      <p className="mb-4">
                        ...
                        <br />
                        <span className="text-sm text-gray-500">(2024.03 ~ 11)</span>
                      </p>
                      <p className="text-base leading-[1.8]">
