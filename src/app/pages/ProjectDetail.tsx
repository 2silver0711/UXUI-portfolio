  ...
  return (
    <div className="bg-black relative w-full pt-24">
      ...
      <div className="relative z-10 max-w-[1920px] mx-auto px-8 md:px-16 lg:px-20 py-12 pb-24">
            ...
            <div className="inline-block px-6 py-2 bg-[#2a2a2a]/50 backdrop-blur-sm rounded-full border border-white/10">
              <span className="font-['Suisse_Int\'l:Regular',sans-serif] text-sm text-[#a0a0a0] tracking-wider uppercase">
                {project.category === 'service' ? 'Service Project' : 
                 project.category === 'product' ? 'Product Design' : 'UX/UI Project'}
              </span>
            </div>
        ...
        {/* Budget Buddy, 로컬링크 Problem 이미지 - 전체 너비 */}
        ...
        {/* Budget Buddy, 로컬링크 Solution 이미지 처음 2개 먼저 표시 */}
        {(project.id === 'budgetBuddy' || project.id === 'locallink') && project.solutionImages && project.solutionImages.length > 0 && (
        ...
        {/* Budget Buddy, 로컬링크 Solution 이미지 - 전체 너비 */}
        {project.id !== 'stoov' && project.id !== 'budgetBuddy' && project.id !== 'locallink' && project.solutionImages && project.solutionImages.length > 0 && (
          <div className="mt-12 space-y-8 mb-20">
        ...
        {/* Budget Buddy Solution 나머지 이미지 (3번째부터) */}
        {project.id === 'budgetBuddy' && project.solutionImages && project.solutionImages.length > 2 && (
          <div className="mt-12 space-y-8 mb-20">
        ...
        {/* Budget Buddy, 로컬링크 Result 이미지 먼저 표시 - 전체 너비 */}
