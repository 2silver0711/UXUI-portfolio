    ...
    <div className="relative w-full bg-black">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-8 md:px-16 lg:px-20 pt-32 pb-20 min-h-screen flex flex-col">
        ...
        <div className="relative w-full max-w-6xl mx-auto mb-28 group">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <span className="font-semibold italic text-3xl md:text-4xl text-white/70 group-hover:text-white transition-colors duration-500" style={{ fontFamily: 'var(--font-garamond)' }}>
                2024
              </span>
            </div>
            ...
            <div className="flex items-center">
              <span className="font-semibold italic text-3xl md:text-4xl text-white group-hover:text-white transition-colors duration-500" style={{ fontFamily: 'var(--font-garamond)' }}>
                2026
              </span>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center mb-24">
          {/* Main Headline */}
          <div className="mb-20">
            <h1 className="font-bold italic text-6xl md:text-8xl lg:text-9xl leading-[1.3] mb-0" style={{ fontFamily: 'var(--font-garamond)' }}>
          ...
          <div className="flex flex-wrap gap-5 justify-center mb-28">
            {[
              ...
              { label: 'Product Design', filter: 'product', projectId: 'budgetBuddy' }
            ].map((category) => (
              <button
                key={category.filter}
                onClick={() => navigate(`/projects/${category.projectId}`)}
                className="px-10 py-4 rounded-full border border-white/40 hover:border-white text-xl text-white tracking-wider transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/10 hover:bg-white/5"
          ...
          <div className="max-w-3xl space-y-10">
            ...
            <p className="text-xl md:text-2xl text-white leading-[1.8]" style={{ fontFamily: 'var(--font-pretendard)' }}>
        ...
        <div className="mt-32 mb-20">
          ...
          <div className="flex items-center justify-between mb-12">
            <h2 className="font-bold italic text-5xl md:text-6xl" style={{ fontFamily: 'var(--font-garamond)' }}>
            ...
            <Link 
              to="/projects"
              className="text-lg text-white/70 hover:text-white transition-colors flex items-center gap-2 group"
              style={{ fontFamily: 'var(--font-suisse)' }}
            >
              View All
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="inline-block mb-3 px-4 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                    <span className="text-xs text-white/80 tracking-wider uppercase" style={{ fontFamily: 'var(--font-suisse)' }}>
                      {project.category === 'service' ? 'Service' : 
                       project.category === 'renewal' ? 'Renewal' : 
                       project.category === 'product' ? 'Product' : 'UX/UI'}
                    </span>
                  </div>

                  {/* Title */}
                  <h3 className="font-bold text-2xl text-white mb-2 group-hover:text-white/90 transition-colors" style={{ fontFamily: 'var(--font-pretendard)' }}>
                    {project.title}
                  </h3>

                  {/* Period */}
                  <p className="text-sm text-white/60 mb-4" style={{ fontFamily: 'var(--font-pretendard)' }}>
                    {project.period}
                  </p>

                  {/* Description */}
                  <p className="text-base text-white/80 leading-[1.6] line-clamp-2" style={{ fontFamily: 'var(--font-pretendard)' }}>
                    {project.description}
                  </p>
        ...
        <div className="text-right mt-auto">
          <p className="font-medium italic text-3xl md:text-4xl text-white/50" style={{ fontFamily: 'var(--font-garamond)' }}>
